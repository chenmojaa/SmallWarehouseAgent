...
export const translations: Record<string, { zh: string; en: string }> = {
  ...
  'ui.auth.001': { zh: '请输入当前密码', en: '请输入当前密码' },
  'ui.auth.002': { zh: '请输入注册时的手机号', en: '请输入注册时的手机号' },
  'ui.chat.001': { zh: '+ 新对话', en: '+ 新对话' },
  'ui.chat.002': { zh: '分叉：复制对话与全部消息到新会话', en: '分叉：复制对话与全部消息到新会话' },
  'ui.chat.003': { zh: '搜索会话标题或预览片段', en: '搜索会话标题或预览片段' },
  'ui.chat.004': { zh: '搜索对话', en: '搜索对话' },
  'ui.chat.005': { zh: '没有匹配的对话', en: '没有匹配的对话' },
  'ui.chat.006': { zh: '点击 + 新对话 开始', en: '点击 + 新对话 开始' },
  'ui.misc.001': { zh: 'Agent 可以直接读写本机所有磁盘的文件', en: 'Agent 可以直接读写本机所有磁盘的文件' },
  'ui.misc.002': { zh: 'HTTP 模式无需启动参数', en: 'HTTP 模式无需启动参数' },
  'ui.misc.003': { zh: 'PDF · DOCX · PPTX · XLSX · CSV · HTML · TXT/MD · 图片 OCR', en: 'PDF · DOCX · PPTX · XLSX · CSV · HTML · TXT/MD · 图片 OCR' },
  'ui.misc.004': { zh: '。请确认你了解其中的风险。可随时切回「默认权限」恢复逐次确认。', en: '。请确认你了解其中的风险。可随时切回「默认权限」恢复逐次确认。' },
  'ui.misc.005': { zh: '下载', en: '下载' },
  'ui.misc.006': { zh: '下载 zip', en: '下载 zip' },
  'ui.misc.007': { zh: '不再询问你', en: '不再询问你' },
  'ui.misc.008': { zh: '从预设库一键安装，或者手动添加。', en: '从预设库一键安装，或者手动添加。' },
  'ui.misc.009': { zh: '全部服务', en: '全部服务' },
  'ui.misc.010': { zh: '全部状态', en: '全部状态' },
  'ui.misc.011': { zh: '全部空间', en: '全部空间' },
  'ui.misc.012': { zh: '刷新状态', en: '刷新状态' },
  'ui.misc.013': { zh: '助手正在「默认权限」模式下运行，执行以下操作前需要你的确认：', en: '助手正在「默认权限」模式下运行，执行以下操作前需要你的确认：' },
  'ui.misc.014': { zh: '历史记录', en: '历史记录' },
  'ui.misc.015': { zh: '历史记录加载失败', en: '历史记录加载失败' },
  'ui.misc.016': { zh: '发起试试', en: '发起试试' },
  'ui.misc.017': { zh: '启动参数', en: '启动参数' },
  'ui.misc.018': { zh: '命令行', en: '命令行' },
  'ui.misc.019': { zh: '基本信息', en: '基本信息' },
  'ui.misc.020': { zh: '如不想每次确认，可在输入框下方开启「完全访问」权限', en: '如不想每次确认，可在输入框下方开启「完全访问」权限' },
  'ui.misc.021': { zh: '已添加', en: '已添加' },
  'ui.misc.022': { zh: '平均延迟', en: '平均延迟' },
  'ui.misc.023': { zh: '开启后，', en: '开启后，' },
  'ui.misc.024': { zh: '待索引', en: '待索引' },
  'ui.misc.025': { zh: '思考过程', en: '思考过程' },
  'ui.misc.026': { zh: '总服务', en: '总服务' },
  'ui.misc.027': { zh: '总调用', en: '总调用' },
  'ui.misc.028': { zh: '成功', en: '成功' },
  'ui.misc.029': { zh: '我的服务', en: '我的服务' },
  'ui.misc.030': { zh: '手动添加', en: '手动添加' },
  'ui.misc.031': { zh: '拖拽文件到这里', en: '拖拽文件到这里' },
  'ui.misc.032': { zh: '推荐预设', en: '推荐预设' },
  'ui.misc.033': { zh: '搜索标题或摘要', en: '搜索标题或摘要' },
  'ui.misc.034': { zh: '文件结构', en: '文件结构' },
  'ui.misc.035': { zh: '新内容会自动解析并进入检索索引', en: '新内容会自动解析并进入检索索引' },
  'ui.misc.036': { zh: '服务名称', en: '服务名称' },
  'ui.misc.037': { zh: '本地', en: '本地' },
  'ui.misc.038': { zh: '本地内容', en: '本地内容' },
  'ui.misc.039': { zh: '来源', en: '来源' },
  'ui.misc.040': { zh: '来源：', en: '来源：' },
  'ui.misc.041': { zh: '来自 GitHub · anthropics/skills', en: '来自 GitHub · anthropics/skills' },
  'ui.misc.042': { zh: '查看', en: '查看' },
  'ui.misc.043': { zh: '标题（可选）', en: '标题（可选）' },
  'ui.misc.044': { zh: '正在加载…', en: '正在加载…' },
  'ui.misc.045': { zh: '测试', en: '测试' },
  'ui.misc.046': { zh: '添加内容', en: '添加内容' },
  'ui.misc.047': { zh: '用途说明', en: '用途说明' },
  'ui.misc.048': { zh: '结果预览', en: '结果预览' },
  'ui.misc.049': { zh: '给这套配置起个名字', en: '给这套配置起个名字' },
  'ui.misc.050': { zh: '编辑', en: '编辑' },
  'ui.misc.051': { zh: '请选择包含', en: '请选择包含' },
  'ui.misc.052': { zh: '超时', en: '超时' },
  'ui.misc.053': { zh: '选择文件', en: '选择文件' },
  'ui.misc.054': { zh: '重建索引', en: '重建索引' },
  'ui.misc.055': { zh: '错误', en: '错误' },
  'ui.misc.056': { zh: '预设库', en: '预设库' },
  'ui.misc.057': { zh: '飞', en: '飞' },
  'ui.misc.058': { zh: '高级配置', en: '高级配置' },
  'ui.misc.059': { zh: '（JSON 对象）', en: '（JSON 对象）' },
  'ui.misc.060': { zh: '（JSON 数组）', en: '（JSON 数组）' },
  'ui.misc.061': { zh: '（可选）', en: '（可选）' },
  'ui.misc.062': { zh: '，执行操作前', en: '，执行操作前' },
  'ui.misc.063': { zh: '🔄 刷新', en: '🔄 刷新' },
  'ui.misc.064': { zh: '🗑 清空', en: '🗑 清空' },
  'ui.models.001': { zh: '+ 添加模型', en: '+ 添加模型' },
  'ui.models.002': { zh: '一键加入。加入后会被模型自动发现，随时可调用。', en: '一键加入。加入后会被模型自动发现，随时可调用。' },
  'ui.models.003': { zh: '添加模型', en: '添加模型' },
  'ui.models.004': { zh: '点击「测试」可立即校验连通性，验证后会被模型自动调用。', en: '点击「测试」可立即校验连通性，验证后会被模型自动调用。' },
  'ui.models.005': { zh: '识别模型', en: '识别模型' },
  'ui.notes.001': { zh: '保存并入库', en: '保存并入库' },
  'ui.notes.002': { zh: '抓取入库', en: '抓取入库' },
  'ui.notes.003': { zh: '笔记', en: '笔记' },
  'ui.notes.004': { zh: '粘贴文章链接', en: '粘贴文章链接' },
  'ui.notes.005': { zh: '粘贴需要保存的文本…', en: '粘贴需要保存的文本…' },
  'ui.notes.006': { zh: '还没有本地知识内容', en: '还没有本地知识内容' },
  'ui.notes.007': { zh: '飞书知识库', en: '飞书知识库' },
  'ui.skills.001': { zh: '&nbsp;添加 MCP', en: '&nbsp;添加 MCP' },
  'ui.skills.002': { zh: 'SKILL.md 内容', en: 'SKILL.md 内容' },
  'ui.skills.003': { zh: '也可以将技能文件夹直接拖拽到这里', en: '也可以将技能文件夹直接拖拽到这里' },
  'ui.skills.004': { zh: '已配置的 MCP', en: '已配置的 MCP' },
  'ui.skills.005': { zh: '我的技能', en: '我的技能' },
  'ui.skills.006': { zh: '技能 · MCP', en: '技能 · MCP' },
  'ui.skills.007': { zh: '推荐技能', en: '推荐技能' },
  'ui.skills.008': { zh: '搜索技能名称或描述', en: '搜索技能名称或描述' },
  'ui.skills.009': { zh: '正在加载技能…', en: '正在加载技能…' },
  'ui.skills.010': { zh: '没有匹配的推荐技能', en: '没有匹配的推荐技能' },
  'ui.skills.011': { zh: '添加技能', en: '添加技能' },
  'ui.skills.012': { zh: '的技能文件夹或压缩包（.zip / .tar.gz / .tgz）', en: '的技能文件夹或压缩包（.zip / .tar.gz / .tgz）' },
  'ui.skills.013': { zh: '还没有 MCP 服务', en: '还没有 MCP 服务' },
  'ui.sync.001': { zh: '当前尚未启用飞书同步', en: '当前尚未启用飞书同步' },
  'ui.sync.002': { zh: '暂无同步后的飞书内容', en: '暂无同步后的飞书内容' },
  'ui.sync.003': { zh: '正在加载飞书内容…', en: '正在加载飞书内容…' },
  'ui.sync.004': { zh: '集中管理本地文件、网页、文本，以及飞书文档和多维表格。', en: '集中管理本地文件、网页、文本，以及飞书文档和多维表格。' },
